        ...
        if(!error)
        {
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                for (NSDictionary* machine in factoryViewData) {
                    ...
                    if ([[UIScreen mainScreen] bounds].size.height == 667) //iPhone 6 size
                    {
                        jobCont.frame = CGRectMake(120, 98, 110, 60);
                    }
                    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
                    {
                        jobCont.frame = CGRectMake(120, 98, 110, 60);
                    ...
                    {
                        jobCont.frame = CGRectMake(machineContainer.frame.size.width/3, 200, machineContainer.frame.size.width/3-10, 140);
                    }
                    else if([[UIScreen mainScreen] bounds].size.height == 1366)  //ipad pro 12.9
                    {
                        jobCont.frame = CGRectMake(120, 98, 110, 60);
                    ...
                    if ([[UIScreen mainScreen] bounds].size.height == 667) //iPhone 6 size
                    {
                        titleCont.frame = CGRectMake(120, 32, 110, 60);
                    }
                    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
                    {
                        titleCont.frame = CGRectMake(120, 32, 110, 60);
                    ...
                    {
                        titleCont.frame = CGRectMake(machineContainer.frame.size.width/3, 52, machineContainer.frame.size.width/3-10, 140);
                    }
                    else if([[UIScreen mainScreen] bounds].size.height == 1366)  //ipad pro 12.9
                    {
                        titleCont.frame = CGRectMake(120, 32, 110, 60);
                    ...
                    if ([[UIScreen mainScreen] bounds].size.height == 667) //iPhone 6 size
                    {
                        titleLabel.frame = CGRectMake(0,0,titleCont.frame.size.width,15);
                        [titleLabel setFont:[UIFont boldSystemFontOfSize:8]];
                    }
                    else if ([[UIScreen mainScreen] bounds].size.height == 736) //iPhone 6+ size
                    {
                        titleLabel.frame = CGRectMake(0,0,titleCont.frame.size.width,8);
                        [titleLabel setFont:[UIFont boldSystemFontOfSize:8]];
                    }
                    else if ([[UIScreen mainScreen] bounds].size.height == 812) //iPhone X size
                    {
                    ...
                    [titleLabel setBackgroundColor:midColor];
                    [titleCont addSubview:titleLabel];
                    
                    UIView *titleMachineCont = [[UIView alloc] init];
                    titleMachineCont.frame = CGRectMake(0, 15, titleCont.frame.size.width, titleCont.frame.size.height-15);
                    ...
                    titleMachineValue.frame = CGRectMake(0,0,titleMachineCont.frame.size.width,titleMachineCont.frame.size.height);
